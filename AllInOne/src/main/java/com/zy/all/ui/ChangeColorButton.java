...
public class ChangeColorButton extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        BitmapDrawable mIconDrawable = (BitmapDrawable) a.getDrawable(R.styleable.ChangeColorButton_ChangeColorButtonIcon);
        mIconBitmap = mIconDrawable.getBitmap();

        mColor = a.getColor(R.styleable.ChangeColorButton_ChangeColorButtonColor, mColor);
